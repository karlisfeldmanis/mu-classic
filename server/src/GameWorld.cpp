...
static const MonsterTypeDef s_monsterDefs[] = {
    ...
    {45, "Bahamut",          2400,  65,  52, 130, 140, 215, 43, 1.6f, 0.4f, 2, 4, 1, true,   8.0f},
    {46, "Vepar",            2800,  70,  58, 135, 145, 225, 45, 1.6f, 0.4f, 3, 7, 4, true,   8.0f},
    {47, "Valkyrie",         3200,  75,  64, 140, 150, 230, 46, 1.8f, 0.4f, 3, 7, 5, true,   8.0f},
    {48, "Lizard King",      9000, 180, 115, 240, 270, 350, 70, 1.6f, 0.4f, 3, 7, 3, true,  15.0f},
    {49, "Hydra",           19000, 200, 125, 250, 310, 430, 74, 1.4f, 0.4f, 3, 7, 4, true, 150.0f},
    {50, "Sea Worm",        19000, 200, 125, 250, 310, 430, 74, 1.4f, 0.4f, 3, 7, 4, true, 150.0f},
    {51, "Great Bahamut",    7000, 150,  98, 210, 230, 330, 66, 1.6f, 0.4f, 3, 7, 2, true,  15.0f},
    {52, "Silver Valkyrie",  8000, 170, 110, 230, 260, 340, 68, 1.6f, 0.4f, 3, 7, 4, true,  15.0f},
    // --- Tarkan monsters (OpenMU Version095d Tarkan.cs) ---
    {57, "Iron Wheel",        17000, 215, 150, 280, 330, 446, 80, 1.4f, 0.4f, 3, 7, 4, true,  10.0f},
    {58, "Tantallos",         22000, 250, 175, 335, 385, 500, 83, 1.4f, 0.4f, 3, 7, 2, true,  20.0f},
    {59, "Zaikan",            34000, 400, 185, 510, 590, 550, 90, 1.4f, 0.4f, 3, 7, 5, true, 150.0f},
    {60, "Bloody Wolf",       13500, 200, 130, 260, 300, 410, 76, 1.4f, 0.4f, 3, 7, 2, true,  10.0f},
    {61, "Beam Knight",       25000, 275, 190, 375, 425, 530, 84, 1.4f, 0.4f, 3, 7, 4, true,  20.0f},
    {62, "Mutant",            10000, 190, 120, 250, 280, 365, 72, 1.4f, 0.4f, 3, 7, 1, true,  10.0f},
    {63, "Death Beam Knight", 40000, 420, 220, 590, 650, 575, 93, 1.4f, 0.4f, 3, 7, 5, true, 150.0f},
